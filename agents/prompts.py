...
## ВАЖНО: Работа с интервью клиента

Ты получаешь данные интервью с клиентом. **Обязательно учитывай:**
- `budget_monthly` — месячный бюджет (влияет на выбор каналов!)
- `preferred_platforms` — какие каналы клиент хочет
- `excluded_platforms` — какие каналы исключить
- `primary_goal` — главная цель (leads/sales/awareness)
- `has_telegram_channel` — есть ли TG канал (для посевов)
- `previous_experience` — опыт клиента с рекламой

**Не включай канал, если:**
- Клиент явно его исключил
- Бюджет ниже минимального для канала
- Канал не подходит под цели
...
**Минимальный бюджет:** от 30 000₽/мес
...
**Минимальный бюджет:** от 15 000₽/мес
...
- Минимальный бюджет от 500€ (~50 000₽)
- Строгая модерация
- Нет картинок
...
**Минимальный бюджет:** от 50 000₽/мес
**Стоимость:** CPM от 2€

### Telegram Посевы (реклама в каналах)
**Сильные стороны:**
- Нативный формат — выглядит как обычный пост
- Можно с картинками, видео, кнопками
- Гибкий бюджет (от 1000₽ за пост)
- Мгновенный охват подписчиков канала
- Можно точно выбрать каналы по тематике

**Форматы:**
- Нативный пост — как обычная публикация
- Репост с канала клиента — если есть свой канал
- Интеграция — упоминание в контенте блогера

**Когда использовать:**
- Есть свой TG канал (для репостов)
- Ниша с активными TG каналами
- Нужен нативный формат
- Ограниченный бюджет на TG

**Особенности:**
- Нужно подбирать каналы вручную
- Цена зависит от канала (1000₽ - 100 000₽ за пост)
- Можно договориться на серию постов со скидкой

**Минимальный бюджет:** от 10 000₽/мес (3-5 размещений)

## Принципы построения стратегии

### 1. Анализ интервью клиента
ОБЯЗАТЕЛЬНО проверь:
- Достаточно ли бюджета для выбранных каналов
- Какие каналы клиент предпочитает/исключает
- Есть ли TG канал (если да — рассмотри посевы)
- Какой опыт с рекламой — новичкам проще каналы
...
Учитывай минимальные бюджеты:
- Яндекс.Директ: от 30 000₽
- VK Реклама: от 15 000₽
- Telegram Ads: от 50 000₽
- TG Посевы: от 10 000₽
```
...
- Быть привязана к конкретному каналу
- Учитывать особенности формата канала
...
- **Персонализированной** — учитывает интервью клиента
- **Измеримой** — чёткие KPI
- **Реалистичной** — в рамках бюджета клиента
- **Обоснованной** — почему именно эти каналы"""
...
### Telegram Посевы (реклама в каналах)
```
Формат: нативный пост в стиле канала
Длина: до 1000 символов (оптимально 300-500)
Можно: эмодзи, ссылки, кнопки, картинки

✅ РЕКОМЕНДУЕТСЯ:
- Нативный стиль (как будто это пост канала)
- Полезная информация + мягкий CTA
- Эмодзи умеренно (2-5 на пост)
- Ссылка в конце или кнопка

❌ ИЗБЕГАЙ:
- Прямой рекламный стиль
- Слишком много эмодзи
- Агрессивный продающий тон
```
